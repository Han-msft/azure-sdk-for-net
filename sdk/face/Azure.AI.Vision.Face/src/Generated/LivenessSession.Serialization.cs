...
{
    public partial class LivenessSession : IUtf8JsonSerializable
    {
        ...
        internal static LivenessSession DeserializeLivenessSession(JsonElement element)
        {
            ...
            Optional<LivenessSessionAuditEntry> result = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("result"u8))
                {
                    ...
                    result = LivenessSessionAuditEntry.DeserializeLivenessSessionAuditEntry(property.Value);
                    continue;
                }
            ...
            return new LivenessSession(deviceCorrelationId, Optional.ToNullable(authTokenTimeToLiveInSeconds), livenessOperationMode, id, createdDateTime, Optional.ToNullable(sessionStartDateTime), sessionExpired, status, result.Value);
        }
