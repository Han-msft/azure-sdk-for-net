...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessWithVerifySession : LivenessSessionCreationContent
    {
        ...
        public LivenessWithVerifySession(string deviceCorrelationId, string livenessOperationMode, DateTimeOffset createdDateTime, bool sessionExpired, SessionStatus status) : base(deviceCorrelationId, livenessOperationMode)
        {
        ...
        internal LivenessWithVerifySession(string deviceCorrelationId, int? authTokenTimeToLiveInSeconds, string livenessOperationMode, string id, DateTimeOffset createdDateTime, DateTimeOffset? sessionStartDateTime, bool sessionExpired, SessionStatus status, LivenessWithVerifySessionAuditEntry result) : base(deviceCorrelationId, authTokenTimeToLiveInSeconds, livenessOperationMode)
        {
            Id = id;
            CreatedDateTime = createdDateTime;
        ...
        public LivenessWithVerifySessionAuditEntry Result { get; set; }
    }
}
