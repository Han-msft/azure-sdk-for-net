...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessSessionAuditEntry
    {
        ...
        public LivenessSessionAuditEntry(string sessionId, string requestId, string clientRequestId, DateTimeOffset receivedDateTime, SessionAuditEntryRequestInfo request, SessionAuditEntryResponseInfo response, string digest)
        {
